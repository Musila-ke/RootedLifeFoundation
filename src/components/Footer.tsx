  ...
  return (
    <footer className="border-t border-neutral-800 bg-neutral-950 text-white">
      <div className="container-page py-10 md:py-16">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5 md:gap-10">
          <div className="lg:col-span-2 -ml-6">
            <Logo variant="footer" />
            <p className="mt-2 max-w-sm text-sm leading-relaxed text-neutral-400 md:mt-4">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-neutral-800 pt-6 sm:flex-row md:mt-12 md:pt-8">
